...
rv32uxsmallfloathinx_snitch_sc_tests = \
	vfadd_h \
	vfcpka_h \
	vfmac_h \
	vfmin_h \
...
rv32uxsmallfloatbinx_snitch_sc_tests = \
	fadd_b \
	fmadd_b \
	fmin_b \
	fsgnj_b \
...
rv32uxsmallfloathinx_mempool_tests = $(addprefix rv32uxsmallfloathinx-mempool-, $(rv32uxsmallfloathinx_snitch_sc_tests))
rv32uxsmallfloatbinx_mempool_tests = $(addprefix rv32uxsmallfloatbinx-mempool-, $(rv32uxsmallfloatbinx_snitch_sc_tests))
...
rtl_mempool_tests += $(rv32uxsmallfloathinx_mempool_tests)
endif
ifeq ($(zquarterinx), 1)
rtl_mempool_tests += $(rv32uxsmallfloatbinx_mempool_tests)
endif
endif
