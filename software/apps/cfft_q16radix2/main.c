...
/* SINGLE-CORE */
    ...
    if (core_id == 0)  {
      ...
      mempool_radix2_cfft_q16s(   (uint16_t) 16,
                                  twiddleCoef_16_q16,
      ...
      mempool_start_benchmark();
      mempool_radix2_cfft_q16s(   (uint16_t) 32,
                                  twiddleCoef_32_q16,
      ...
      mempool_start_benchmark();
      mempool_radix2_cfft_q16s(   (uint16_t) 64,
                                  twiddleCoef_64_q16,
      ...
      mempool_start_benchmark();
      mempool_radix2_cfft_q16s(   (uint16_t) 128,
                                  twiddleCoef_128_q16,
      ...
      mempool_start_benchmark();
      mempool_radix2_cfft_q16s(   (uint16_t) 256,
                                  twiddleCoef_256_q16,
      ...
      mempool_start_benchmark();
      mempool_radix2_cfft_q16s(   (uint16_t) 512,
                                  twiddleCoef_512_q16,
      ...
      mempool_start_benchmark();
      mempool_radix2_cfft_q16s(   (uint16_t) 1024,
      ...
      mempool_start_benchmark();
      mempool_radix2_cfft_q16s(   (uint16_t) 2048,
      ...
      mempool_start_benchmark();
      mempool_radix2_cfft_q16s(   (uint16_t) 4096,
...
/* PARALLEL-CORE */
  ...
  #ifdef  TEST_16
    mempool_start_benchmark();
    mempool_radix2_cfft_q16p(   (uint16_t) 16,
                                twiddleCoef_16_q16,
                                BitRevIndexTable_fixed_16,
                                pSrc,
                                BITREVINDEXTABLE_FIXED_16_TABLE_LENGTH,
  ...
  #elif   defined(TEST_32)
    mempool_start_benchmark();
    mempool_radix2_cfft_q16p(   (uint16_t) 32,
                                twiddleCoef_32_q16,
                                BitRevIndexTable_fixed_32,
                                pSrc,
                                BITREVINDEXTABLE_FIXED_32_TABLE_LENGTH,
  ...
  #elif   defined(TEST_64)
    mempool_start_benchmark();
    mempool_radix2_cfft_q16p(   (uint16_t) 64,
                                twiddleCoef_64_q16,
                                BitRevIndexTable_fixed_64,
                                pSrc,
                                BITREVINDEXTABLE_FIXED_64_TABLE_LENGTH,
  ...
  #elif   defined(TEST_128)
    mempool_start_benchmark();
    mempool_radix2_cfft_q16p(   (uint16_t) 128,
                                twiddleCoef_128_q16,
                                BitRevIndexTable_fixed_128,
                                pSrc,
                                BITREVINDEXTABLE_FIXED_128_TABLE_LENGTH,
  ...
  #elif   defined(TEST_256)
    mempool_start_benchmark();
    mempool_radix2_cfft_q16p(   (uint16_t) 256,
                                twiddleCoef_256_q16,
                                BitRevIndexTable_fixed_256,
                                pSrc,
                                BITREVINDEXTABLE_FIXED_256_TABLE_LENGTH,
  ...
  #elif   defined(TEST_512)
    mempool_start_benchmark();
    mempool_radix2_cfft_q16p(   (uint16_t) 512,
                                twiddleCoef_512_q16,
                                BitRevIndexTable_fixed_512,
                                pSrc,
                                BITREVINDEXTABLE_FIXED_512_TABLE_LENGTH,
  ...
  #elif   defined(TEST_1024)
    mempool_start_benchmark();
    mempool_radix2_cfft_q16p(   (uint16_t) 1024,
                                twiddleCoef_1024_q16,
                                BitRevIndexTable_fixed_1024,
                                pSrc,
                                BITREVINDEXTABLE_FIXED_1024_TABLE_LENGTH,
  ...
  #elif   defined(TEST_2048)
    mempool_start_benchmark();
    mempool_radix2_cfft_q16p(   (uint16_t) 2048,
                                twiddleCoef_2048_q16,
                                BitRevIndexTable_fixed_2048,
                                pSrc,
                                BITREVINDEXTABLE_FIXED_2048_TABLE_LENGTH,
  ...
  #elif   defined(TEST_4096)
    mempool_start_benchmark();
    mempool_radix2_cfft_q16p(   (uint16_t) 4096,
                                twiddleCoef_4096_q16,
                                BitRevIndexTable_fixed_4096,
                                pSrc,
                                BITREVINDEXTABLE_FIXED_4096_TABLE_LENGTH,
