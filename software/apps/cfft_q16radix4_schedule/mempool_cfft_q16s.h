...
void mempool_cfft_q16s(uint16_t fftLen, int16_t *pSrc, int16_t *pCoef,
                       uint16_t *pBitRevTable, uint16_t bitReverseLen,
                       uint8_t bitReverseFlag);

#ifndef XPULP

static inline void radix4_butterfly_first(int16_t *pIn, int16_t Co1,
                                          int16_t Si1, int16_t Co2, int16_t Si2,
                                          int16_t Co3, int16_t Si3, uint32_t i0,
                                          uint32_t n2);

static inline void radix4_butterfly_middle(int16_t *pIn, int16_t Co1,
                                           int16_t Si1, int16_t Co2,
                                           int16_t Si2, int16_t Co3,
                                           int16_t Si3, uint32_t i0,
                                           uint32_t n2);
...
void mempool_cfft_q16s(uint16_t fftLen, int16_t *pSrc, int16_t *pCoef,
  ...
  for (i0 = 0; i0 < n2; i0++) {
    ...
    for (uint32_t idx_fft = 0; idx_fft < N_FFTs; idx_fft++) {
      radix4_butterfly_first(pSrc + idx_fft * 2 * N_BANKS_SINGLE, Co1, Si1, Co2,
                             Si2, Co3, Si3, i0, n2);
    }
#else
    ...
    for (uint32_t idx_fft = 0; idx_fft < N_FFTs; idx_fft++) {
      radix4_butterfly_first(pSrc + idx_fft * 2 * N_BANKS_SINGLE, i0, n2, CoSi1,
  ...
  for (k = fftLen / 4U; k > 4U; k >>= 2U) {
    ...
    for (j = 0U; j <= (n2 - 1U); j++) {
      ...
      for (i0 = j; i0 < fftLen; i0 += n1) {
        for (uint32_t idx_fft = 0; idx_fft < N_FFTs; idx_fft++) {
          radix4_butterfly_middle(pSrc + idx_fft * 2 * N_BANKS_SINGLE, Co1, Si1,
                                  Co2, Si2, Co3, Si3, i0, n2);
        }
      }
#else
      ...
      for (i0 = j; i0 < fftLen; i0 += n1) {
        for (uint32_t idx_fft = 0; idx_fft < N_FFTs; idx_fft++) {
          radix4_butterfly_middle(pSrc + idx_fft * 2 * N_BANKS_SINGLE, i0, n2,
...
static inline void radix4_butterfly_first(int16_t *pSrc, int16_t Co1,
                                          int16_t Si1, int16_t Co2, int16_t Si2,
                                          int16_t Co3, int16_t Si3, uint32_t i0,
                                          uint32_t n2) {
