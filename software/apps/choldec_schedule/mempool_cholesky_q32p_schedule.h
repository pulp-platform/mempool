...
void mempool_cholesky_q32p_fold(int32_t *pSrcA, int32_t *pSrcB, int32_t *pLL,
                                ...
                                const uint32_t fracBits, const uint32_t nPE);
...
dump(index, 1)
    ...
    void mempool_cholesky_q32p_fold(int32_t *pSrcA, int32_t *pSrcB,
...
void mempool_cholesky_q32p_FLsqrtsum(int32_t *pSrc, int32_t *pL,
  ...
  if (core_id == (idx_col >> 2U)) {
    ...
    pL[idx_col * N_BANKS + idx_col] =
        mempool_sqrt_q32s((pivot - sum), fracBits);
  }
}
...
void mempool_cholesky_q32p_FRsqrtsum(int32_t *pSrc, int32_t *pL,
  ...
  if (core_id == nPE - 1 - (idx_col >> 2U)) {
    ...
    pL[idx_col * N_BANKS + n - 1 - idx_col] =
        mempool_sqrt_q32s((pivot - sum), fracBits);
  }
}
