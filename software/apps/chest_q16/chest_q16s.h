...
/**
  ...
  @return        none
*/
void mempool_chest_q16s_unrolled4(int16_t* pH, int16_t* pPilotRX, int16_t* pPilotTX, uint32_t nRX, uint32_t nTX, uint32_t nSc) {
...
/**
  ...
  @return        none
*/
void mempool_chest_q16s_unrolled2(int16_t* pH, int16_t* pPilotRX, int16_t* pPilotTX, uint32_t nRX, uint32_t nTX, uint32_t nSc) {
...
/**
  ...
  @return        none
*/
void mempool_chest_q16s_unrolled4_xpulpv2(int16_t* pH, int16_t* pPilotRX, int16_t* pPilotTX, uint32_t nRX, uint32_t nTX, uint32_t nSc) {
