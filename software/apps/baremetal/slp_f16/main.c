...
int main() {
  ...
  // ITR 0: l1_X_curr => l1_X_A; l1_Y_curr => l1_Y_A; l1_X_next => l1_X_B;
  // l1_Y_next => l1_Y_B; l1_Y_prev => null ITR 1: l1_X_curr => l1_X_B;
  // l1_Y_curr => l1_Y_B; l1_X_next => l1_X_A; l1_Y_next => l1_Y_C; l1_Y_prev =>
  // l1_Y_A ITR 2: l1_X_curr => l1_X_A; l1_Y_curr => l1_Y_C; l1_X_next =>
  // l1_X_B; l1_Y_next => l1_Y_A; l1_Y_prev => l1_Y_B ITR 3: l1_X_curr =>
  // l1_X_B; l1_Y_curr => l1_Y_A; l1_X_next => l1_X_A; l1_Y_next => l1_Y_B;
  // l1_Y_prev => l1_Y_C
  // ...
