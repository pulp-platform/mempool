 ...
 * @param[in]  pSrc   points to the instance of the input floating-point matrix
 * structure.
 * @param[out] pDst   points to the instance of the output floating-point
 * triangular matrix structure.
 * @param[out] pDiag   points to the instance of the output floating-point
 * diagonal matrix structure.
 * @param[out] pPerm   points to the instance of the output floating-point
 * permutation vector.
 ...
 */
void mempool_ldlcholesky_q32s(int32_t *pSrc, int32_t *pDst, int32_t *pDiag,
                              uint32_t n, uint32_t *pPerm) {
