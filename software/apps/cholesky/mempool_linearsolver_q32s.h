...
void mempool_linearsolver_q32s_folded(int32_t *pSrc, int32_t *pL,
...
/**
  @brief         Cholesky-Crout decomposition plus solution of the linear system
  Ly=b
  @param[in]     pSrc  points to input matrix
  @param[out]    pL points to output lower triangular matrix
  @param[in/out] pIn input b vector, the output vector is computed in place
  @param[in]     n matrix dimentsion
  @return        none
*/
void mempool_linearsolver_q32s(int32_t *pSrc, int32_t *pL,
                               volatile int32_t *pIn, const uint32_t n) {
...
/**
  @brief         Folded Cholesky-Crout decomposition plus solution of the linear
  system Ly=b
  @param[in]     pSrc  points to input matrix
  @param[out]    pL points to output lower triangular matrix
  @param[in/out] pIn input b vector, the output vector is computed in place
...
void mempool_linearsolver_q32s_fld(int32_t *pSrc, int32_t *pL,
                                   int32_t volatile *pIn, const uint32_t n) {
...
/**
  @brief         Solution of lower triangular system
...
/**
  @brief         Solution of upper triangular system
  @param[in]     pL points to input lower triangular matrix
  @param[in/out] pIn points to input vector b
  @param[in]     n system dimension
  @return        none
...
/**
  @brief         Folded solution of upper triangular system
  @param[in]     pL points to input lower triangular matrix
  @param[in/out] pIn points to input vector b
  @param[in]     n system dimension
  @return        none
*/
void mempool_uprtrisolver_q32s_fld(int32_t *pL, int32_t *pIn,
                                   const uint32_t n) {
