...
void mempool_cholesky_q32p_FLsqrtsum_fld(int32_t *pSrc, int32_t *pL,
                                         uint32_t core_id, const uint32_t j);

void mempool_cholesky_q32p_FRsqrtsum_fld(int32_t *pSrc, int32_t *pL,
                                         uint32_t core_id, const uint32_t n,
                                         const uint32_t j);

void mempool_cholesky_q32p_FLdivisum_fld(int32_t *pSrc, int32_t *pL,
                                         uint32_t core_id, const uint32_t n,
                                         const uint32_t j);

void mempool_cholesky_q32p_FRdivisum_fld(int32_t *pSrc, int32_t *pL,
                                         uint32_t core_id, const uint32_t n,
                                         const uint32_t j);
...
/**
  ...
  @param[in/out] pL points to the lower triangular matrix
...
/**
  @brief         Folded sqrt stage of Cholesky decomposition
  @param[in]     pSrc points to input matrix
...
/**
  @brief         Folded division stage of Cholesky decomposition
  @param[in]     pSrc points to input matrix
  @param[in/out] pL points to left folded lower triangular matrix
  @param[in/out] pIn points to input vector
  @param[in]     n system dimension
