...
RUNTIME ?= $(ROOT_DIR)/crt0.S.o $(ROOT_DIR)/printf.c.o $(ROOT_DIR)/string.c.o $(ROOT_DIR)/synchronization.c.o $(ROOT_DIR)/serial.c.o $(ROOT_DIR)/alloc.c.o $(ROOT_DIR)/omp.c.o $(ROOT_DIR)/barrier.c.o $(ROOT_DIR)/critical.c.o $(ROOT_DIR)/single.c.o
