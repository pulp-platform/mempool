...
DEFINES += -DSQRT_NUM_CORES_PER_TILE=$(shell awk 'BEGIN{print sqrt($(num_cores_per_tile))}')
...
DEFINES += -DSQRT_NUM_TILES_PER_GROUP=$(shell awk 'BEGIN{print sqrt(($(num_cores)/$(num_groups))/$(num_cores_per_tile))}')
...
RISCV_FLAGS_GCC    ?= -mcmodel=medany -Wa,-march=$(RISCV_ARCH_AS) -mtune=mempool -ffixed-x5 -ffixed-x6 -ffixed-x7 -ffixed-x28 # -falign-loops=32 -falign-jumps=32
