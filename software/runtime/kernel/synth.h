...
static inline void power_profile_mempool(int32_t *const a, uint32_t core_id) {
  // Calculate unique address in remote bank
  const uint32_t NUM_BANKS_PER_TILE = NUM_CORES_PER_TILE * BANKING_FACTOR;
  ...
  __asm__ volatile(
      ...
      ".balign 16 \n\t"
      "6: \n\t"
      "pv.max.h %[op_0],%[op_a0],%[op_a4] \n\t"
      "pv.max.h %[op_1],%[op_a1],%[op_a5] \n\t"
      "pv.max.h %[op_2],%[op_a2],%[op_a6] \n\t"
      "pv.max.h %[op_3],%[op_a3],%[op_a7] \n\t"
      "pv.max.h %[op_0],%[op_a0],%[op_a4] \n\t"
      "pv.max.h %[op_1],%[op_a1],%[op_a5] \n\t"
      "pv.max.h %[op_2],%[op_a2],%[op_a6] \n\t"
      "pv.max.h %[op_3],%[op_a3],%[op_a7] \n\t"
      ...
      ".balign 16 \n\t"
      "7: \n\t"
      "div %[op_0],%[op_a0],%[op_a4] \n\t"
      "div %[op_1],%[op_a1],%[op_a5] \n\t"
      "div %[op_2],%[op_a2],%[op_a6] \n\t"
      "div %[op_3],%[op_a3],%[op_a7] \n\t"
      "div %[op_0],%[op_a0],%[op_a4] \n\t"
      "div %[op_1],%[op_a1],%[op_a5] \n\t"
      "div %[op_2],%[op_a2],%[op_a6] \n\t"
      "div %[op_3],%[op_a3],%[op_a7] \n\t"
...
static inline void power_profile_terapool(int32_t *const a, uint32_t core_id) {
  // Address to load from are [addr:addr+3]
  const uint32_t NUM_BANKS_PER_TILE = NUM_CORES_PER_TILE * BANKING_FACTOR;
  volatile int32_t *addr_local =
      &a[core_id * (NUM_BANKS_PER_TILE / NUM_CORES_PER_TILE)];
...
static inline void power_profile_terapool_lw_rtile(int32_t *const a,
                                                   uint32_t remote_tile) {
...
static inline void power_profile_terapool_lw_rgrup(int32_t *const a,
