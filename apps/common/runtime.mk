...
RISCV_FLAGS    ?= -march=$(RISCV_ABI) -I$(CURDIR)/common -DITERATIONS=10 -mcmodel=medany -static -std=gnu99 -O3 -ffast-math -fno-common -fno-builtin-printf
...
%.S.o: %.S
	$(GCC_INSTALL_DIR)/bin/$(RISCV_CC) -Iinclude $(RISCV_CCFLAGS) -c $< -o $@

%.c.o: %.c
	$(GCC_INSTALL_DIR)/bin/$(RISCV_CC) -Iinclude $(RISCV_CCFLAGS) -c $< -o $@

%.cpp.o: %.cpp
	$(GCC_INSTALL_DIR)/bin/$(RISCV_CXX) $(RISCV_CXXFLAGS) -c $< -o $@
