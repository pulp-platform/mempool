...
RISCV_FLAGS_GCC    ?= -mcmodel=medany -Wa,-march=$(RISCV_ARCH_AS) -falign-loops=16 -falign-jumps=16
#RISCV_FLAGS_GCC    ?= -mcmodel=medany -Wa,-march=$(RISCV_ARCH_AS) -falign-loops=16 -falign-jumps=16 -funroll-loops
