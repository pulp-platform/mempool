...
package riscv_instr;
  ...
  localparam [31:0] VFAVG_AB           = 32'b1010110??????????011?????0110011;
  localparam [31:0] VFAVG_AH           = 32'b1010110??????????010?????0110011;
  localparam [31:0] VFAVG_B            = 32'b1010110??????????011?????0110011;
  localparam [31:0] VFAVG_H            = 32'b1010110??????????010?????0110011;
  localparam [31:0] VFAVG_R_AB         = 32'b1010110??????????111?????0110011;
  localparam [31:0] VFAVG_R_AH         = 32'b1010110??????????110?????0110011;
  ...
  localparam [31:0] VFDOTP_AB          = 32'b1001010??????????011?????0110011;
  localparam [31:0] VFDOTP_AH          = 32'b1001010??????????010?????0110011;
  localparam [31:0] VFDOTP_B           = 32'b1001010??????????011?????0110011;
  localparam [31:0] VFDOTP_H           = 32'b1001010??????????010?????0110011;
  localparam [31:0] VFDOTP_R_AB        = 32'b1001010??????????111?????0110011;
  localparam [31:0] VFDOTP_R_AH        = 32'b1001010??????????110?????0110011;
