...
if {$config == {terapool}} {
  ...
  add wave -noupdate -group cache[$1][$2][$3][$4][$5] -group lookup  /mempool_tb/dut/gen_clusters[$1]/i_mempool_cluster/gen_groups[$2]/gen_rtl_group/i_group/gen_sub_groups[$3]/gen_rtl_sg/i_sub_group/gen_tiles[$4]/i_tile/gen_caches[$5]/i_snitch_icache/gen_serial_lookup/i_lookup/*
  ...
  add wave -noupdate -group cache[$1][$2][$3][$4] -group lookup  /mempool_tb/dut/gen_clusters[$1]/i_mempool_cluster/gen_groups[$2]/i_group/gen_tiles[$3]/i_tile/gen_caches[$4]/i_snitch_icache/gen_serial_lookup/i_lookup/*
