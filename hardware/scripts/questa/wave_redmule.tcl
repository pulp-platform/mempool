...
if {$config == {terapool}} {
  ...
  add wave -noupdate -group redmule[$1][$2] /mempool_tb/dut/i_mempool_cluster/gen_groups[$1]/i_group/gen_tiles[$2]/gen_redmule_tile/i_tile/redmule_tcdm_resp
  add wave -noupdate -group redmule[$1][$2] /mempool_tb/dut/i_mempool_cluster/gen_groups[$1]/i_group/gen_tiles[$2]/gen_redmule_tile/i_tile/redmule_tcdm_resp_valid
